...
public class NotificationController {
    ...
    public void sendNotificationToUser(@RequestParam Integer userId, @RequestParam String message) {
    ...
    public void sendNotificationToGroup(@RequestParam String group, @RequestParam String message) {
